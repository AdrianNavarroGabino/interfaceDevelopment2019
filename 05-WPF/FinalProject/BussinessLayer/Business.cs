...
namespace BusinessLayer
{
    public class Business
    {
        ...
        public Usuario Validate(string mail, string pas)
        {
        ...
        public Localidad GetTown(string provinceId, string townId)
        {
            List<Localidad> towns = GetTowns();

            foreach(Localidad t in towns)
            {
                if(t.localidadID == townId && t.provinciaID == provinceId)
                {
                    return t;
                }
            }
